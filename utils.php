<?php
	...
	function test_arrays_compare() {
		echo "We are testing arrays_compare" . PHP_EOL;
		$arr1 = ['apple', 'orange', 'strawberry'];
		$arr2 = ['potato', 'cabbage', 'tomato'];
		$arr3 = ['potatoto', 'cabbage', 'tomatoto'];
		$arr4 = ['potato111', 'cabbage222', 'tomato333'];
		test(4 ,arrays_compare($arr1, $arr2));
		test(2 ,arrays_compare($arr2, $arr3));
		test(3 ,arrays_compare($arr3, $arr4));
	}
